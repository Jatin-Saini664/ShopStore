...
const CustomerLogin = () => {
    ...
    function onsubmit(){
        ...
        fetch("http://127.0.0.1:8000/custLogin",attribute)
    ...
    return (
        <div style={{display:"flex", justifyContent:"center", marginTop:"5vh"}}>
            ...
            <fieldset className="form-group">
                <legend className="border-bottom mb-4">Login As a Customer</legend>
                <div className="mb-3">
        ...
        <div className="border-top pt-3">
            <small className="text-muted">
                Need an account ? <Link to="/shop/customerSignup" className="ml-2">Sign up Now</Link>
            </small>
        </div>
    </div>
        </div>
