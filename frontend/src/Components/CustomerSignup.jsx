...
const CustomerSignup = () => {
    ...
    function onsub(){
        ...
        fetch("http://127.0.0.1:8000/custRegister", attribute)
        ...
        <div style={{display:"flex", justifyContent:"center", marginTop:"5vh"}}>
            <div style={{width:"65%"}} className= "content-section">
                    <fieldset className="form-group">
                        <legend className="border-bottom mb-4">SignUp As a Customer</legend>
                        <div>
                            <div className="mb-3">
                ...
                <div className="border-top pt-3">
                    <small className="text-muted">
                        Already have an account ? <Link className="ml-2" to="/shop/customerLogin">Login</Link>
                    </small>
                </div>
            </div>
        </div>
